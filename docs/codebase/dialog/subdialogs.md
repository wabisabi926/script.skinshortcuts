...
**Child receives:** Same manager, schema, icon_sources, context_menu, subdialogs. Different dialog_mode and property_suffix. Deleted/removed items are tracked inside the shared manager, not passed separately.
...
- `icon_sources`, `context_menu`, `subdialogs`
